...
<body id="home">
	...
	<div class="section-out">
		...
		<section class="signup-section">
			<div class="login">
				<form id="form_signup" name="form_signup" action="signup.php" method="post">
					<ul class="ul-list">
						<li><input type="radio" id="student" name="check-type" onchange="check_type()" value="student" checked> Student&emsp;<input type="radio" id="inst" name="check-type" value="institute" onchange="check_type()"> Lecturer&emsp;</li>
						...
						<li><input type="text" required class="input" id="reg_uname" name="reg_uname" pattern="^[a-z\d\.]{5,}$" placeholder="ID Number" onchange="check_user()"/><span class="icon"><i class="material-icons">person</i></span></li>
	...
	<div class="welcome wrap-width">
		...
		<div class="welcome-text">
			<p id="text-heading">webportal.me</p><br>
			<p id="text-context">This Student portal is a platform where Student and lecturer can visit,<br>this give student the opportunity to access educatioanl material.<br> Lecture Note, Timestable of the institution is availabel. </p>
	...
	<div class="link-container clearfix">
		<div class="wrap-width">
			...
			<p id="join">Join us - Be a part of the growing community.</p>
		</div> 
	</div>	 <!-- link-container -->
	...
	<div class="about-container clearfix wrap-width" id="about">
		...
		<p>this portal is a platform where students can get their documents verified and attested digitally. Companies can view their docs and offer them internships and jobs.</p>
		...
		<div id="form-main">
    		...
    		<div class="contact-div contact-detail">
    			...
    			<div class="detail-container" id="phone-no">
    				...
    				<p class="contact-context" id="phone-text">(+232)88750786</p>
    			</div>
    			<div class="detail-container" id="email-id">
    				<i class="material-icons second">email</i>
	    			<p class="contact-context" id="mail-text">ansumanaaugustine@gmail.com</p>
	    		</div>
	...
	<footer>
		...
		<div id="copyrights">
				<span class="siteName">group6 ©  2020. All rights reserved.</span>
            </div><!--copyrights-->
	</footer>
